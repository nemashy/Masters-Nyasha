...
% Robert's suggestion
running_idxs_1 = running_idxs(1:2307);
running_idxs_2 = running_idxs(2308:end);
...
walking_idxs_1 = walking_idxs(1:3004);
walking_idxs_2 = walking_idxs(3005:end);
...
training_set_idxs_cv = [train_sphere_idxs validation_sphere_idxs train_two_walking_idxs validation_two_walking_idxs train_clutter_idxs validation_clutter_idxs train_vehicle_idxs validation_vehicle_idxs train_walking_idxs_2 validation_walking_idxs_2 train_walking_idxs_1 validation_walking_idxs_1 train_running_idxs_2 validation_running_idxs_2 train_running_idxs_1 validation_running_idxs_1];
testing_set_idxs_cv = [test_sphere_idxs test_two_walking_idxs test_clutter_idxs test_vehicle_idxs test_walking_idxs_2 test_walking_idxs_1 test_running_idxs_2 test_running_idxs_1];
